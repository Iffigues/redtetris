...
exports.Context = exports.Provider = exports.ALERT_POP = void 0;
...
var sendAlert = function sendAlert(dispatch) {
  return function (message, typeAlert) {
    return dispatch({
      type: ALERT_POP,
      typeAlert: typeAlert,
      message: message
